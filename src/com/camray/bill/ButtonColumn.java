	...
	implements TableCellRenderer, TableCellEditor, ActionListener, MouseListener
{
	...
	public ButtonColumn(JTable table,BillModel model,  int column)
	{
		this.table = table;
		this.model=model;

		renderButton = new JButton("Del");
...
//
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		PassFrame pframe=new PassFrame(row,model);
		}
		else{
			model.removebill(row);
		}
		fireEditingStopped();
